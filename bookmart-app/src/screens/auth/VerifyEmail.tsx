import { resendOtp, verifyRegisterOtp } from "@/types/auth";
...
const VerifyEmail = () => {
  ...
  const resendMutation = useMutation({
    ...
    onSuccess: () => {
      const msg = "A new 4-digit verification code has been sent!";
  ...
  const handleResend = useCallback(() => {
    if (!email || email === "your email") {
      Alert.alert("Error", "No email provided to resend code.");
      return;
    }
